...
var (
	md_QueryAllDebtRequest         protoreflect.MessageDescriptor
	fd_QueryAllDebtRequest_address protoreflect.FieldDescriptor
)

func init() {
	file_elys_stablestake_query_proto_init()
	md_QueryAllDebtRequest = File_elys_stablestake_query_proto.Messages().ByName("QueryAllDebtRequest")
	fd_QueryAllDebtRequest_address = md_QueryAllDebtRequest.Fields().ByName("address")
}

var _ protoreflect.Message = (*fastReflection_QueryAllDebtRequest)(nil)

type fastReflection_QueryAllDebtRequest QueryAllDebtRequest

func (x *QueryAllDebtRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryAllDebtRequest)(x)
}

func (x *QueryAllDebtRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryAllDebtRequest_messageType fastReflection_QueryAllDebtRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryAllDebtRequest_messageType{}

type fastReflection_QueryAllDebtRequest_messageType struct{}

func (x fastReflection_QueryAllDebtRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryAllDebtRequest)(nil)
}
func (x fastReflection_QueryAllDebtRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryAllDebtRequest)
}
func (x fastReflection_QueryAllDebtRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAllDebtRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryAllDebtRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAllDebtRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryAllDebtRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryAllDebtRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryAllDebtRequest) New() protoreflect.Message {
	return new(fastReflection_QueryAllDebtRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryAllDebtRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryAllDebtRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryAllDebtRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_QueryAllDebtRequest_address, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryAllDebtRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtRequest.address":
		return x.Address != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.stablestake.QueryAllDebtRequest"))
		}
		panic(fmt.Errorf("message elys.stablestake.QueryAllDebtRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtRequest.address":
		x.Address = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryAllDebtRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.stablestake.QueryAllDebtRequest.address":
		value := x.Address
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message elys.stablestake.QueryAllDebtRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtRequest.address":
		x.Address = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtRequest.address":
		panic(fmt.Errorf("field address of message elys.stablestake.QueryAllDebtRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.stablestake.QueryAllDebtRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryAllDebtRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtRequest.address":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryAllDebtRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.stablestake.QueryAllDebtRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryAllDebtRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryAllDebtRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryAllDebtRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryAllDebtRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAllDebtRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAllDebtRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var _ protoreflect.List = (*_QueryAllDebtResponse_1_list)(nil)

type _QueryAllDebtResponse_1_list struct {
	list *[]*Debt
}

func (x *_QueryAllDebtResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryAllDebtResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryAllDebtResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Debt)
	(*x.list)[i] = concreteValue
}

func (x *_QueryAllDebtResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Debt)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryAllDebtResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(Debt)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryAllDebtResponse_1_list) Truncate(n int) {
...
func (x *_QueryAllDebtResponse_1_list) NewElement() protoreflect.Value {
	v := new(Debt)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryAllDebtResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryAllDebtResponse      protoreflect.MessageDescriptor
	fd_QueryAllDebtResponse_debt protoreflect.FieldDescriptor
)

func init() {
	file_elys_stablestake_query_proto_init()
	md_QueryAllDebtResponse = File_elys_stablestake_query_proto.Messages().ByName("QueryAllDebtResponse")
	fd_QueryAllDebtResponse_debt = md_QueryAllDebtResponse.Fields().ByName("debt")
}

var _ protoreflect.Message = (*fastReflection_QueryAllDebtResponse)(nil)

type fastReflection_QueryAllDebtResponse QueryAllDebtResponse

func (x *QueryAllDebtResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryAllDebtResponse)(x)
}

func (x *QueryAllDebtResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryAllDebtResponse_messageType fastReflection_QueryAllDebtResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryAllDebtResponse_messageType{}

type fastReflection_QueryAllDebtResponse_messageType struct{}

func (x fastReflection_QueryAllDebtResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryAllDebtResponse)(nil)
}
func (x fastReflection_QueryAllDebtResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryAllDebtResponse)
}
func (x fastReflection_QueryAllDebtResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAllDebtResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryAllDebtResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAllDebtResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryAllDebtResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryAllDebtResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryAllDebtResponse) New() protoreflect.Message {
	return new(fastReflection_QueryAllDebtResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryAllDebtResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryAllDebtResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryAllDebtResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Debt) != 0 {
		value := protoreflect.ValueOfList(&_QueryAllDebtResponse_1_list{list: &x.Debt})
		if !f(fd_QueryAllDebtResponse_debt, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryAllDebtResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtResponse.debt":
		return len(x.Debt) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.stablestake.QueryAllDebtResponse"))
		}
		panic(fmt.Errorf("message elys.stablestake.QueryAllDebtResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtResponse.debt":
		x.Debt = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryAllDebtResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.stablestake.QueryAllDebtResponse.debt":
		if len(x.Debt) == 0 {
			return protoreflect.ValueOfList(&_QueryAllDebtResponse_1_list{})
		}
		listValue := &_QueryAllDebtResponse_1_list{list: &x.Debt}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.stablestake.QueryAllDebtResponse"))
		}
		panic(fmt.Errorf("message elys.stablestake.QueryAllDebtResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtResponse.debt":
		lv := value.List()
		clv := lv.(*_QueryAllDebtResponse_1_list)
		x.Debt = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.stablestake.QueryAllDebtResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtResponse.debt":
		if x.Debt == nil {
			x.Debt = []*Debt{}
		}
		value := &_QueryAllDebtResponse_1_list{list: &x.Debt}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryAllDebtResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.stablestake.QueryAllDebtResponse.debt":
		list := []*Debt{}
		return protoreflect.ValueOfList(&_QueryAllDebtResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.stablestake.QueryAllDebtResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryAllDebtResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.stablestake.QueryAllDebtResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryAllDebtResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAllDebtResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryAllDebtResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryAllDebtResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryAllDebtResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Debt) > 0 {
			for iNdEx := len(x.Debt) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.Debt[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAllDebtResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAllDebtResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.Debt = append(x.Debt, &Debt{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Debt[len(x.Debt)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *QueryAllDebtRequest) Reset() {
	*x = QueryAllDebtRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_stablestake_query_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryAllDebtRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryAllDebtRequest) ProtoMessage() {}

// Deprecated: Use QueryAllDebtRequest.ProtoReflect.Descriptor instead.
func (*QueryAllDebtRequest) Descriptor() ([]byte, []int) {
	return file_elys_stablestake_query_proto_rawDescGZIP(), []int{2}
}

func (x *QueryAllDebtRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *QueryAllDebtResponse) Reset() {
	*x = QueryAllDebtResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_stablestake_query_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryAllDebtResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryAllDebtResponse) ProtoMessage() {}

// Deprecated: Use QueryAllDebtResponse.ProtoReflect.Descriptor instead.
func (*QueryAllDebtResponse) Descriptor() ([]byte, []int) {
	return file_elys_stablestake_query_proto_rawDescGZIP(), []int{3}
}

func (x *QueryAllDebtResponse) GetDebt() []*Debt {
	if x != nil {
		return x.Debt
	}
	return nil
...
var file_elys_stablestake_query_proto_rawDesc = []byte{
	...
	0x65, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1b, 0x65, 0x6c,
	0x79, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x2f, 0x64,
	0x65, 0x62, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2c, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x62,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x72, 0x6f, 0x77, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x32, 0xed, 0x06, 0x0a, 0x05, 0x51, 0x75,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x73, 0x74, 0x61, 0x62,
	...
	0x61, 0x6b, 0x65, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x99, 0x01, 0x0a, 0x0b, 0x42,
	0x6f, 0x72, 0x72, 0x6f, 0x77, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x12, 0x29, 0x2e, 0x65, 0x6c, 0x79,
	0x73, 0x2e, 0x73, 0x74, 0x61, 0x62, 0x6c, 0x65, 0
proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_elys_stablestake_query_proto_goTypes = []interface{}{
	(*QueryDebtRequest)(nil),         // 0: elys.stablestake.QueryDebtRequest
	(*QueryDebtResponse)(nil),        // 1: elys.stablestake.QueryDebtResponse
	(*QueryAllDebtRequest)(nil),      // 2: elys.stablestake.QueryAllDebtRequest
	(*QueryAllDebtResponse)(nil),     // 3: elys.stablestake.QueryAllDebtResponse
	(*QueryParamsRequest)(nil),       // 4: elys.stablestake.QueryParamsRequest
	(*QueryParamsResponse)(nil),      // 5: elys.stablestake.QueryParamsResponse
	(*QueryAmmPoolRequest)(nil),      // 6: elys.stablestake.QueryAmmPoolRequest
	(*QueryAmmPoolResponse)(nil),     // 7: elys.stablestake.QueryAmmPoolResponse
	(*QueryAllAmmPoolsRequest)(nil),  // 8: elys.stablestake.QueryAllAmmPoolsRequest
	(*QueryAllAmmPoolsResponse)(nil), // 9: elys.stablestake.QueryAllAmmPoolsResponse
	(*QueryBorrowRatioRequest)(nil),  // 10: elys.stablestake.QueryBorrowRatioRequest
	(*QueryBorrowRatioResponse)(nil), // 11: elys.stablestake.QueryBorrowRatioResponse
	(*Debt)(nil),                     // 12: elys.stablestake.Debt
...
var file_elys_stablestake_query_proto_depIdxs = []int32{
	12, // 0: elys.stablestake.QueryDebtResponse.debt:type_name -> elys.stablestake.Debt
	12, // 1: elys.stablestake.QueryAllDebtResponse.debt:type_name -> elys.stablestake.Debt
	13, // 2: elys.stablestake.QueryParamsResponse.params:type_name -> elys.stablestake.Params
	14, // 3: elys.stablestake.QueryAmmPoolResponse.amm_pool:type_name -> elys.stablestake.AmmPool
	14, // 4: elys.stablestake.QueryAllAmmPoolsResponse.amm_pools:type_name -> elys.stablestake.AmmPool
	4,  // 5: elys.stablestake.Query.Params:input_type -> elys.stablestake.QueryParamsRequest
	10, // 6: elys.stablestake.Query.BorrowRatio:input_type -> elys.stablestake.QueryBorrowRatioRequest
	6,  // 7: elys.stablestake.Query.AmmPool:input_type -> elys.stablestake.QueryAmmPoolRequest
	8,  // 8: elys.stablestake.Query.AllAmmPools:input_type -> elys.stablestake.QueryAllAmmPoolsRequest
	0,  // 9: elys.stablestake.Query.Debt:input_type -> elys.stablestake.QueryDebtRequest
	2,  // 10: elys.stablestake.Query.AllDebt:input_type -> elys.stablestake.QueryAllDebtRequest
	5,  // 11: elys.stablestake.Query.Params:output_type -> elys.stablestake.QueryParamsResponse
	11, // 12: elys.stablestake.Query.BorrowRatio:output_type -> elys.stablestake.QueryBorrowRatioResponse
	7,  // 13: elys.stablestake.Query.AmmPool:output_type -> elys.stablestake.QueryAmmPoolResponse
	9,  // 14: elys.stablestake.Query.AllAmmPools:output_type -> elys.stablestake.QueryAllAmmPoolsResponse
	1,  // 15: elys.stablestake.Query.Debt:output_type -> elys.stablestake.QueryDebtResponse
	3,  // 16: elys.stablestake.Query.AllDebt:output_type -> elys.stablestake.QueryAllDebtResponse
...
func file_elys_stablestake_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_elys_stablestake_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryAllDebtRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_elys_stablestake_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryAllDebtResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
